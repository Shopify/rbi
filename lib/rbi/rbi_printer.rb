...
module RBI
  ...
  class File
    ...
    def print(out: $stdout, indent: 0, print_locs: false, max_line_length: nil)
      p = RBIPrinter.new(out: out, indent: indent, print_locs: print_locs, max_line_length: max_line_length)
      p.visit_file(self)
    end
