...
class RBI::RBSPrinter < ::RBI::Visitor
  ...
  sig { params(sig_param: T.nilable(::RBI::SigParam), multiline: T::Boolean).void }
  def print_method_sig_block(sig_param, multiline:); end
  ...
  sig { params(node: ::RBI::Method, sig: ::RBI::Sig).returns(T::Array[[::RBI::SigParam, ::RBI::Param]]) }
  def sig_method_param_pairs(node, sig); end

  sig { params(sig_param: ::RBI::SigParam, method_param: ::RBI::Param).returns(T::Boolean) }
  def sig_param_matches_method_param?(sig_param, method_param); end
