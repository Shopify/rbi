...
module RBI
  ...
  class Attr
    ...
    sig { params(name: String, sig: T.nilable(Sig), visibility: Visibility, loc: T.nilable(Loc), comments: T::Array[Comment]).returns(Method) }
    def create_getter_method(name, sig, visibility, loc, comments); end

    # rubocop:disable Metrics/ParameterLists
    sig { params(name: String, sig: T.nilable(Sig), attribute_type: T.nilable(T.any(Type, String)), visibility: Visibility, loc: T.nilable(Loc), comments: T::Array[Comment]).returns(Method) }
