...
module RBI
  ...
  class Type
    ...
    class << self
      ...
      sig { params(name: String, params: T.any(Type, Array)).returns(Generic) }
      ...
      sig { params(types: T.any(Type, Array)).returns(Tuple) }
      def tuple(*types); end

      # Builds a type that represents a shape type like `{name: String, age: Integer}`.
      sig { params(types: Hash).returns(Shape) }
      def shape(types = {}); end
