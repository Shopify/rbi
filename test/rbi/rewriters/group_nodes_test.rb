...
module RBI
  class GroupNodesTest < Minitest::Test
    ...
    def test_group_sort_nested_groups
      ...
      sscope << TStructProp.new("SP2", Type.simple("Type"))
      sscope << TStructConst.new("SC2", Type.simple("Type"))
      ...
      sscope << TStructProp.new("SP1", Type.simple("Type"))
      sscope << TStructConst.new("SC1", Type.simple("Type"))
      ...
      scope << Helper.new("h2")
      scope << TStructProp.new("SP2", Type.simple("Type"))
      scope << TStructConst.new("SC2", Type.simple("Type"))
      scope << TEnum.new("TE2")
      ...
      scope << Helper.new("h1")
      scope << TStructProp.new("SP1", Type.simple("Type"))
      scope << TStructConst.new("SC1", Type.simple("Type"))
      scope << TEnum.new("TE1")
