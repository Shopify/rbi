  ...
  class GenerateTest < Minitest::Test
    ...
    def test_bump_unregistered_gem
      ...
      Bundler.with_unbundled_env do
        ...
        _, err, status = project.bundle_exec("rbi bump colorize --no-netrc #{index} --no-color")
        assert_log(<<~OUT, err)
    ...
    def test_bump_gem_without_version
      project = self.project("test_bump_gem_without_version")
      ...
      Bundler.with_unbundled_env do
        ...
        _, err, status = project.bundle_exec("rbi bump foo --path=#{path} --no-netrc #{index} --no-color")
        assert_log(<<~OUT, err)
