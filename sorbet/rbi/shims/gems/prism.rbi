...
module Prism
  ...
  class AliasGlobalVariableNode < Node
    ...
    sig do
      params(keys: T::Array[Symbol]).returns(T::Hash[Symbol,
        T.nilable(T.any(Node, T::Array[Node], String, Token, T::Array[Token], Location))])
    end
  ...
  class BlockParameterNode < Node
    ...
    sig do
      params(name: T.nilable(Symbol), name_loc: T.nilable(Location), operator_loc: Location, location: Location).void
    end
  ...
  class CallNode < Node
    ...
    def initialize(receiver, call_operator_loc, message_loc, opening_loc, arguments, closing_loc, block, flags, name,
      location)
    end
  ...
  class ClassNode < Node
    ...
    def initialize(locals, class_keyword_loc, constant_path, inheritance_operator_loc, superclass, body,
      end_keyword_loc, name, location)
    end
  ...
  class ClassVariableWriteNode < Node
    ...
    sig do
      params(name: Symbol, name_loc: Location, value: Node, operator_loc: T.nilable(Location), location: Location).void
    end
  ...
  class ConstantPathOperatorWriteNode < Node
    ...
    sig do
      params(target: ConstantPathNode, operator_loc: Location, value: Node, operator: Symbol, location: Location).void
    end
  ...
  class DefNode < Node
    ...
    def initialize(name, name_loc, receiver, parameters, body, locals, def_keyword_loc, operator_loc, lparen_loc,
      rparen_loc, equal_loc, end_keyword_loc, location)
    end
  ...
  class ForNode < Node
    ...
    def initialize(index, collection, statements, for_keyword_loc, in_keyword_loc, do_keyword_loc, end_keyword_loc,
      location)
    end
  ...
  module DSL
    ...
    sig do
      params(new_name: Node, old_name: Node, keyword_loc: Location, location: Location).returns(AliasGlobalVariableNode)
    end
    ...
    def BeginNode(begin_keyword_loc, statements, rescue_clause, else_clause, ensure_clause, end_keyword_loc, location)
    end
    ...
    def CallNode(receiver, call_operator_loc, message_loc, opening_loc, arguments, closing_loc, block, flags, name,
      location)
    end
    ...
    def ClassNode(locals, class_keyword_loc, constant_path, inheritance_operator_loc, superclass, body,
      end_keyword_loc, name, location)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(ClassVariableAndWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator: Symbol,
        location: Location,
      ).returns(ClassVariableOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(ClassVariableOrWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator: Symbol,
        location: Location,
      ).returns(ConstantOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(ConstantPathAndWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator: Symbol,
        location: Location,
      ).returns(ConstantPathOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(ConstantPathOrWriteNode)
    end
    ...
    sig do
      params(
        ...
        delimiter_loc: Location,
        location: Location,
      ).returns(ConstantPathTargetNode)
    end
    ...
    def DefNode(name, name_loc, receiver, parameters, body, locals, def_keyword_loc, operator_loc, lparen_loc,
      rparen_loc, equal_loc, end_keyword_loc, location)
    end
    ...
    sig do
      params(
        ...
        closing_loc: Location,
        location: Location,
      ).returns(EmbeddedStatementsNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(GlobalVariableAndWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator: Symbol,
        location: Location,
      ).returns(GlobalVariableOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(GlobalVariableOrWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator_loc: Location,
        location: Location,
      ).returns(GlobalVariableWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(InstanceVariableAndWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator: Symbol,
        location: Location,
      ).returns(InstanceVariableOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        value: Node,
        location: Location,
      ).returns(InstanceVariableOrWriteNode)
    end
    ...
    sig do
      params(
        ...
        flags: Integer,
        location: Location,
      ).returns(InterpolatedMatchLastLineNode)
    end
    ...
    sig do
      params(
        ...
        closing_loc: T.nilable(Location),
        location: Location,
      ).returns(InterpolatedStringNode)
    end
    ...
    sig do
      params(
        ...
        closing_loc: Location,
        location: Location,
      ).returns(InterpolatedXStringNode)
    end
    ...
    sig do
      params(name: Symbol, name_loc: Location, value: T.nilable(Node), location: Location).returns(KeywordParameterNode)
    end
    ...
    sig do
      params(
        ...
        depth: Integer,
        location: Location,
      ).returns(LocalVariableAndWriteNode)
    end
    ...
    sig do
      params(
        ...
        depth: Integer,
        location: Location,
      ).returns(LocalVariableOperatorWriteNode)
    end
    ...
    sig do
      params(
        ...
        depth: Integer,
        location: Location,
      ).returns(LocalVariableOrWriteNode)
    end
    ...
    sig do
      params(
        ...
        operator_loc: Location,
        location: Location,
      ).returns(LocalVariableWriteNode)
    end
    ...
    sig do
      params(
        parameters: T::Array[Node],
        opening_loc: Location,
        closing_loc: Location,
        location: Location,
      ).returns(RequiredDestructuredParameterNode)
    end
