...
class RBI::Tree < ::RBI::NodeWithComments
  # source://rbi/0.2.4/lib/rbi/model.rb#115
  def initialize(loc: T.unsafe(nil), comments: T.unsafe(nil), &block); end

  # source://rbi/0.2.4/lib/rbi/model.rb#122
  def <<(node); end

  # source://rbi/0.2.4/lib/rbi/rewriters/add_sig_templates.rb#67
  def add_sig_templates!(with_todo_comment: T.unsafe(nil)); end

  # source://rbi/0.2.4/lib/rbi/rewriters/annotate.rb#50
  ...
  # source://rbi/0.2.4/lib/rbi/rewriters/deannotate.rb#42
  def deannotate!(annotation); end

  # source://rbi/0.2.4/lib/rbi/model.rb#128
  def empty?; end

  # source://rbi/0.2.4/lib/rbi/rewriters/filter_versions.rb#119
  def filter_versions!(version); end

  # source://rbi/0.2.4/lib/rbi/rewriters/flatten_singleton_methods.rb#61
  def flatten_singleton_methods!; end

  # source://rbi/0.2.4/lib/rbi/rewriters/flatten_visibilities.rb#61
  def flatten_visibilities!; end

  # source://rbi/0.2.4/lib/rbi/rewriters/group_nodes.rb#82
  def group_nodes!; end

  # source://rbi/0.2.4/lib/rbi/index.rb#69
  def index; end

  # source://rbi/0.2.4/lib/rbi/rewriters/merge_trees.rb#328
  def merge(other, left_name: T.unsafe(nil), right_name: T.unsafe(nil), keep: T.unsafe(nil)); end

  # source://rbi/0.2.4/lib/rbi/rewriters/nest_non_public_members.rb#47
  def nest_non_public_members!; end

  # source://rbi/0.2.4/lib/rbi/rewriters/nest_singleton_methods.rb#37
  def nest_singleton_methods!; end

  # source://rbi/0.2.4/lib/rbi/rewriters/nest_top_level_members.rb#64
  def nest_top_level_members!; end

  # source://rbi/0.2.4/lib/rbi/model.rb#112
  def nodes; end

  # source://rbi/0.2.4/lib/rbi/rewriters/attr_to_methods.rb#54
  def replace_attributes_with_methods!; end

  # source://rbi/0.2.4/lib/rbi/rewriters/sort_nodes.rb#120
  def sort_nodes!; end
