...
class Spoom::TestHelpers::Project
  ...
  def remove(rel_path); end

  sig { params(content: String).void }
  def sorbet_config(content); end

  sig { params(rel_path: String, content: String).void }
  def write(rel_path, content = T.unsafe(nil)); end

  private

  sig { params(rel_path: String).returns(String) }
  def absolute_path(rel_path); end
end
